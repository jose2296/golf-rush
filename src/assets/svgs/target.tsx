...
const Target = ({ fill = 'none', stroke = 'none', strokeWidth = 2, className }: props) => (
    <svg version='1.1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' className={className}>
        <g>
            <path fill={fill} stroke={stroke} strokeWidth={strokeWidth} d='M204.762,254.456l34.212-34.204c-39.807-18.293-88.544-11.079-121.29,21.675
		...
		c-25.21-25.21-25.21-66.224,0-91.427C163.546,257.016,184.794,251.074,204.762,254.456z'/>
            <path fill={fill} stroke={stroke} strokeWidth={strokeWidth} d='M323.628,241.146c34.324,57.876,26.642,133.939-23.076,183.65c-58.826,58.826-154.527,58.826-213.345,0
		...
		c66.603-66.595,74.518-169.962,23.809-245.358L323.628,241.146z'/>
            <path fill={fill} stroke={stroke} strokeWidth={strokeWidth} d='M511.279,84.84c-1.61-4.195-5.684-6.78-10.298-6.57l-70.565,3.31l3.318-70.556
